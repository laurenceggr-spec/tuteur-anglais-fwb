...
<head>
    ...
    <style>
        ...
        .goal-input { width: 100%; padding: 8px; border-radius: 5px; border: 1px solid #3498DB; margin-top: 5px; font-size: 0.85rem; box-sizing: border-box; background: #EBF5FB; }
...
<div class="app">
    ...
    <div class="settings-bar">
        ...
        <input type="text" id="lesson-goal" class="goal-input" placeholder="Objectif de la leçon (ex: le passé simple, les vêtements...)">
        <div class="challenge-box" id="challenge-txt">Challenge: Use "NAME" (+50 pts)</div>
    </div>
    <div class="topics" id="t-grid"></div>
    <div id="chat"><div class="msg ai">Hello! I'm your tutor. Tell me your lesson goal, choose a topic and let's talk!</div></div>
    <div class="controls">
...
part3 = """
    ...
    async function callAI(userText) {
        ...
        const systemPrompt = "Friendly English Tutor (Belgium). " +
        "Level: " + level + ". Topic: " + topic + ". " +
        "STUDENT LESSON GOAL: " + goal + ". " +
        "Note: Focus questions on the student goal if possible. If they have a French name like 'Laurence', recognize it. " +
        "Rules: 1 sentence response, correct errors, end with 1 question.";
        ...
        } catch(e) { addMsg("Error. Please try again.", "ai"); }
    }
